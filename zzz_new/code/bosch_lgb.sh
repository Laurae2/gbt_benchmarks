...
Rscript bosch_lgb.R ${DIR} 8 na leaves release
Rscript bosch_lgb.R ${DIR} 8 na depth release
Rscript bosch_lgb.R ${DIR} 8 na hessian release
Rscript bosch_lgb.R ${DIR} 8 na sampling release
Rscript bosch_lgb.R ${DIR} 7 na leaves release
Rscript bosch_lgb.R ${DIR} 7 na depth release
Rscript bosch_lgb.R ${DIR} 7 na hessian release
Rscript bosch_lgb.R ${DIR} 7 na sampling release
Rscript bosch_lgb.R ${DIR} 6 na leaves release
Rscript bosch_lgb.R ${DIR} 6 na depth release
Rscript bosch_lgb.R ${DIR} 6 na hessian release
Rscript bosch_lgb.R ${DIR} 6 na sampling release
