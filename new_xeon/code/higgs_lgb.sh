...
Rscript higgs_lgb.R ${DIR} 40 na leaves release
Rscript higgs_lgb.R ${DIR} 40 na depth release
Rscript higgs_lgb.R ${DIR} 40 na hessian release
Rscript higgs_lgb.R ${DIR} 40 na sampling release
Rscript higgs_lgb.R ${DIR} 20 na leaves release
Rscript higgs_lgb.R ${DIR} 20 na depth release
Rscript higgs_lgb.R ${DIR} 20 na hessian release
Rscript higgs_lgb.R ${DIR} 20 na sampling release
Rscript higgs_lgb.R ${DIR} 10 na leaves release
Rscript higgs_lgb.R ${DIR} 10 na depth release
Rscript higgs_lgb.R ${DIR} 10 na hessian release
Rscript higgs_lgb.R ${DIR} 10 na sampling release
