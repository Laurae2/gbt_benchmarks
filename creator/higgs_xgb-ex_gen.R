...
xgb.DMatrix.save(xgb_train, fname = paste0("../data/higgs_train_xgb-", commandArgs(trailingOnly = TRUE)[2], ".data"))
xgb.DMatrix.save(xgb_test, fname = paste0("../data/higgs_test_xgb-", commandArgs(trailingOnly = TRUE)[2], ".data"))
