...
spec_log <- paste0("../xgb_gbt_", ifelse(type == "depthwise", "dw", "lg"), "/", sprintf("%02d", threads), "t_higgs_", model_type)
model_name <- paste0("Higgs: ", threads, "-thread xgboost ", ifelse(type == "depthwise", "Depth-wise", "Loss-guide"), ", ", model_type, " limited")
file_extension <- ".txt"
