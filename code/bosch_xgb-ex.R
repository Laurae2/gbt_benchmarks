...
spec_log <- paste0("../xgb-", optimization, "_gbt_", ifelse(type == "depthwise", "dw", "lg"), "/", sprintf("%02d", threads), "t_bosch_", model_type)
model_name <- paste0("Bosch: ", threads, "-thread xgboost ", ifelse(type == "depthwise", "Depth-wise", "Loss-guide"), "-", optimization, ", ", model_type, " limited")
file_extension <- ".txt"
